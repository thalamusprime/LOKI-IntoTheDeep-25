...
import org.firstinspires.ftc.teamcode.ftc6205.constants.VisionConstants;
...
public class PixelVision extends LinearOpMode {
    ...
    // Camera: C920
    private static final int CAMERA_WIDTH = 640; //640; // width  of wanted camera resolution
    private static final int CAMERA_HEIGHT = 480; //480; // height of wanted camera resolution
    ...
    class YellowBlobDetectionPipeline extends OpenCvPipeline {
        ...
        private Mat preprocessFrame(Mat frame) {
             ...
             * purple: ?
             */
            Scalar lowerYellow = new Scalar(VisionConstants.Red_Hue_high, 100, 100); //Sat: 100
            Scalar upperYellow = new Scalar(VisionConstants.Red_Hue_high, 255, 255); //Sat: 255
