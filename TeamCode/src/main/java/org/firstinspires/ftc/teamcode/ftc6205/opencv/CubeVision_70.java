...
@Config
@TeleOp(name = "(70) Cube Vision", group = "70")

public class CubeVision_70 extends LinearOpMode {
    HardwareMap hMap;
    ...
    double width = 0;
    //TODO: ""
    public static String cube_spotted = "LEFT";
    ...
    //String token_color = "";
    String token_color = VisionConstants.token_color;
